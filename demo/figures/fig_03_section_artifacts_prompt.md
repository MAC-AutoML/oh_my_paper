...
- Required content: Show grouped artifact families only: section cards, figure prompt cards, explanation cards, references, LaTeX workspace, and audit trail. Use only the allowed labels, not full filenames.
...
- Allowed visible labels: "sections/", "01 Abstract", "02 Introduction", "03 Related Work", "04 Method", "figures/", "fig prompts", "explain/", "why files", "references.bib", "latex workspace", "audit trail"
...
Use only these exact labels: "sections/", "01 Abstract", "02 Introduction", "03 Related Work", "04 Method", "figures/", "fig prompts", "explain/", "why files", "references.bib", "latex workspace", "audit trail".
