...
- Allowed visible labels: "One-shot prompt", "User material", "Candidate ideas", "Reviewer selection", "Section agents", "Citation check", "Review score", "Revise to 85+", "Imagegen figures", "LaTeX package", "Auditable draft"
...
Use only these exact labels: "One-shot prompt", "User material", "Candidate ideas", "Reviewer selection", "Section agents", "Citation check", "Review score", "Revise to 85+", "Imagegen figures", "LaTeX package", "Auditable draft".
