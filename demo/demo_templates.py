...
FIGURES = [('fig_01_workflow_prompt.md', 'Workflow overview', 'Show the full loop: user material -> candidate ideas -> reviewer selection -> citation-aware section writing agents -> reviewer score -> revision until >=85 -> imagegen figures -> LaTeX packaging.'), ('fig_02_score_loop_prompt.md', 'Reviewer score loop', 'Show a revision trajectory from 72 to 81 to 87, with critique packets feeding back to writing agents and citation gaps tracked separately.'), ('fig_03_section_artifacts_prompt.md', 'Section artifact layout', 'Show files named 01_sec_abstract.md through 09_sec_references.md plus fig_01 prompts, explanation files, and an optional LaTeX workspace.')]
